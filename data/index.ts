...
export const HOME_SOCIALS = [
  {
    Icon: FaLinkedin,
    href: "https://www.linkedin.com/in/ammmdmahikaisharme",
  },
  {
    Icon: FaGithub,
    href: "https://www.github.com/ammmdmahikaisharme",
  },
  {
    Icon: FaFacebook,
    href: "https://www.facebook.com/ammmdmahikaisharme",
  },
];

export const ABOUT_DESCRIBTION =
  "I'm a passionate FullStack Developer. Also a MERN Stack Web Developer. I have been coding for a wheeel. I have done lots of project.";
...
export const EXPERIENCE_CARDS = [
  ...
  },
  {
    ...
    abilities: [
      ...
      { id: "ability02", name: "Conda", short: "" },
      { id: "ability03", name: "Node", short: "" },
    ],
  },
];
...
export const CONTACT_TALKS = [
  {
    Icon: BiMailSend,
    name: "Email",
    short: "ammmdmahikaishar.me",
    href: "mailto:ammmdmahikaishar.me@gmail.com",
  },
  {
    Icon: FaWhatsapp,
    name: "Whatsapp",
    short: "+880-17402-34540",
    href: "https://api.whatsapp.com/send?phone=8801740234540&text=Hello!",
  },
  {
    Icon: BsMessenger,
    name: "Messanger",
    short: "ammmdmahikaisharme",
    href: "https://m.me/ammmdmahikaisharme",
  },
];
